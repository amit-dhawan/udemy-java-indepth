package com.sapient.carpricecalculator;
...
public class CarPriceEstimator {
	...
	public static void main(String[] args) {
		...
		double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2020, 21001.0, 2, true, true, true, false,
				false, false);
	}
}
